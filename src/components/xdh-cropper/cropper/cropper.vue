<template>
    <div class="vue-cropper" ref="cropper" @mouseover="scaleImg" @mouseout="cancelScale">
        <div class="cropper-box" v-if="imgs">
            ...
            >
                <img :src="httpImg" alt="cropper-img" ref="cropperImg" />
            </div>
        </div>
        ...
        >
            <span class="cropper-view-box">
                <img ref="cropperImg" :style="style" :src="httpImg" alt="cropper-img" />
            </span>
...
export default {
    ...
    */
    ...
    methods: {
        ...
        // checkout img
        checkedImg() {
            if (this.img.includes('/video=stream&camidx=0?1')) {
                this.imgs = this.img;
            } else {
        ...
        getCropChecked(cb) {
            ...
            img.src = this.cropperImg || this.imgs;
